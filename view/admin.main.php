<?php 
  ...
  $thispage="index2.php?option=".$this->mccom['me'];  // com_comments
?>
<table width="100%" border="1" cellpadding="3" cellspacing="3" bgcolor="#EDF1F1">
<tr>
<td align="center" valign="middle"><?=$this->h->aLink("http://ongetc.com","COAddOns - MosCom"); ?></td>
<td valign="top">
	...
	<tr>
		...
		<td width="50%" align="center" valign="top">
		<?=$this->h->aLink($thispage."&task=config",_COM_A_CONFIG,'')." : ". _COM_A_CONFIG_DESC; ?><br />
		</td>
	</tr>
	</table>
</td>
...
<td width="100%" class="sectionname"><?=_COM_A_REVIEW; ?></td>
<td nowrap="nowrap"><?=_COM_A_DISPLAY; ?></td>
...
<th width="10%" class="title"><?=_COM_A_NAME_SUB ?></th>
<th width="3%" class="title"><?=_COM_A_EMAIL_SUB ?></th>
<th width="4%" class="title"><?=_COM_A_HOMEPAGE ?></th>
<th width="51%" class="title"><?=_COM_A_COMMENT ?></th>
<th width="11%" class="title"><?=_COM_A_ARTICLE ?></th>
<th width="7%" class="title"><?=_COM_A_IP ?></th>
<th width="8%" class="title"><?=_COM_A_DATE ?></th>
<th width="5%" class="title"><?=_COM_A_PUBLISHED ?></th>
</tr>
<?php 
  if ($viewData) { 
    $k = 0;
