...
class MoscomAdmin extends MoscomMain{
...
//    $this->mccom['option']=$option; // must set this for all view to return
    ...
    // comment action
      ...
      echo $this->renderView("admin.editcomment.php");      
  		break;
  	case "savecomment":
...
//    $this->_viewData = $this->comment->dbSelect($search, $limitstart, $limit);    
  ...
  function configAdmin() {
    ...
    if ($upgMsg=$this->isNeedUpg("config")) die ($upgMsg);
      ...
      $this->_viewParm['tagid']='moscomTabs';
      $this->_viewParm['cssfile'] = $this->mccom['mcasiteurl']."css/moscom.ui.tabs.css";
