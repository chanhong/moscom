...
class MoscomConfigModel extends MoscomModel {
  ...
  function schemaArray() {
    ...
    'type'=>'input',
    'name'=>_COM_A_ADMIN_EMAIL, 
    'desc'=>_COM_A_ADMIN_EMAIL_DESC,
    'field'=>"varchar(63) NOT NULL default 'changeme@mail.com'",
    );
    $mcarray['excl_sec'] = array(
    'type'=>'input',
    'name'=>_COM_A_EXCL_SEC, 
    'desc'=>_COM_A_EXCL_SEC_DESC,
    'field'=>"varchar(63) NOT NULL default '0'",    
    );
    $mcarray['excl_contents'] = array(
    'type'=>'input',
    'name'=>_COM_A_EXCL_CONT, 
    'desc'=>_COM_A_EXCL_CONT_DESC,
    'field'=>"varchar(63) NOT NULL default '0'",       
    );
    $mcarray['close_contents'] = array(
    'type'=>'input',
    'name'=>_COM_A_CLOSE_CONT, 
    'desc'=>_COM_A_CLOSE_CONT_DESC,
    'field'=>"varchar(63) NOT NULL default '0'",       
    );     
    $mcarray['per_page'] = array(
    'type'=>'input',
    'name'=>_COM_A_PER_PAGE,
    'desc'=>_COM_A_PER_PAGE_DESC,
    'field'=>"varchar(3) NOT NULL default '15'",       
    );
    $mcarray['donated'] = array(
    'type'=>'radio',
    'name'=>_COM_A_HAVE_DONATED,
    'desc'=>_COM_A_DONATE2,
    'field'=>"varchar(1) NOT NULL default '0'",       
    );
    $mcarray['email_alerts'] = array(
    'type'=>'radio',
    'name'=>_COM_A_ADMIN_ALERTS, 
    'desc'=>_COM_A_ADMIN_EMAIL_ENABLE,
    'field'=>"varchar(1) NOT NULL default '1'",      
    );
    $mcarray['email_alerts_user'] = array(
    'type'=>'radio',
    'name'=>_COM_A_VISITOR_EMAIL,  
    'desc'=>_COM_A_VISITOR_EMAIL_DESC,
    'field'=>"varchar(1) NOT NULL default '0'", 
    );
    $mcarray['review'] = array(
    'type'=>'radio',
    'name'=>_COM_A_REVIEW_SUBM,  
    'desc'=>_COM_A_REVIEW_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",     
    );
    $mcarray['regonly'] = array(
    'type'=>'radio',
    'name'=>_COM_A_REGISTERED_ONLY, 
    'desc'=>_COM_A_REG_ONLY_DESC,
    'field'=>"varchar(1) NOT NULL default '0'",      
    );
    $mcarray['updates'] = array(
    'type'=>'radio',
    'name'=>_COM_A_NOTIFY_VERSION,  
    'desc'=>_COM_A_NOT_VER_DESC,
    'field'=>"varchar(1) NOT NULL default '0'",       
    );
    $mcarray['force_preview'] = array(
    'type'=>'radio',
    'name'=>_COM_A_FORCE_PREVIEW, 
    'desc'=>_COM_A_FORCE_PREVIEW_TEXT,
    'field'=>"varchar(1) NOT NULL default '1'",     
    );
    $mcarray['hide_comments'] = array(
    'type'=>'radio',
    'name'=>_COM_A_HIDE, 
    'desc'=>_COM_A_HIDE_DESC,
    'field'=>"varchar(1) NOT NULL default '0'",     
    );
    $mcarray['hide_url'] = array(
    'type'=>'radio',
    'name'=>_COM_A_HIDE_URL, 
    'desc'=>_COM_A_HIDE_URL_DESC,
    'field'=>"varchar(1) NOT NULL default '0'",        
    );
    $mcarray['email_req'] = array(
    'type'=>'radio',
    'name'=>_COM_A_EMAIL_REQ, 
    'desc'=>_COM_A_EMAIL_REQ_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",     
    );
    $mcarray['new_1st'] = array(
    'type'=>'radio',
    'name'=>_COM_A_NEW_1ST, 
    'desc'=>_COM_A_NEW_1ST_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",  
    );
    $mcarray['form_above'] = array(
    'type'=>'radio',
    'name'=>_COM_A_FORM_ABOVE, 
    'desc'=>_COM_A_FORM_ABOVE_DESC,
    'field'=>"varchar(1) NOT NULL default '0'",     
    );
    $mcarray['use_divcss'] = array(
    'type'=>'radio',
    'name'=>_COM_A_USE_DIVCSS, 
    'desc'=>_COM_A_USE_DIVCSS_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",        
    );
    $mcarray['use_username'] = array(
    'type'=>'radio',
    'name'=>_COM_A_USE_USERNAME, 
    'desc'=>_COM_A_USE_USERNAME_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",        
    ); 
    $mcarray['use_sectoken'] = array(
    'type'=>'radio',
    'name'=>_COM_A_USE_SECTOKEN, 
    'desc'=>_COM_A_USE_SECTOKEN_DESC,
    'field'=>"varchar(1) NOT NULL default '1'",        
    ); 
    return $mcarray;
  }  
...
//    $this->prt($retcfg,__METHOD__);
  ...
  function dbInsertTable() {
    $dbInit = false;
      ...
      $this->dbQueryExec("INSERT INTO `#__content_comments_config` ( `id`) value (0)");
  ...
  function dbCreateTable() {
    return "CREATE TABLE IF NOT EXISTS `#__content_comments_config` (
...
";
  ...
  function dbAlterTable($type, $diffArray) {
    ...
    !empty($fldsList) ? $sql = "ALTER TABLE `#__content_comments_config` ".$fldsList.";" : $sql = "";
  ...
  function dbUpdateTable($iArray) {
    ...
    (!empty($fldList) and !empty($id)) ? $sql = "UPDATE #__content_comments_config SET ".$fldList." where id='".$id."'" : $sql = "";  
    if (!empty($sql)) $this->dbQueryExec($sql);    
  }  
  function dbSelectTable() {
  	$rows = $this->dbQuerySelect("SELECT * FROM `#__content_comments_config` limit 1");
