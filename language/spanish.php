...
define('_COM_A_KEEPUPTODATE','Si quieres mantenerte actualizado con éste y otros excelentes componentes de Chanh Ong subscríbete a la lista de correo clickeando en estos botones');
...
define('_COM_A_HAVE_FUN','Listo! ~ (No contestaré del estilo de &quot;<em>Instalé su componente pero el formulario no se ve.....</em>&quot; :-)</p> <p>          Have Fun!</p> <p>~<a href="http://ongetc.com" target="_blank">Chanh Ong</a>. </p>');
...
define('_COM_A_EXCL_SEC','Sección de Exclusión');
define('_COM_A_EXCL_SEC_DESC','Utilizado para no mostrar la sección de exclusión en el formulario de comentarios por defecto, por ejemplo : 0,1');
define('_COM_A_PER_PAGE','Comenatarios por Página');
define('_COM_A_PER_PAGE_DESC','Utilizador para mostrar el número de comentarios por página, por ejemplo : 3');
...
define('_COM_A_EXCL_CONT','Contenidos Excluídos');
define('_COM_A_EXCL_CONT_DESC','Utilizado para excluir contenidos via ID del artículo no para mostrar el formulario de comentario, por ejemplo : 0,1');
define('_COM_A_IP','IP');
...
define('_COM_C_COM_NUMBER',"Número de comentarios");
define('_COM_C_NO_COM',"Aún no hay comentarios - Agrega uno usando el formulario de abajo ...");
define('_COM_C_POST',"Enviado por ");
define('_COM_C_HOMEPAGE',"Cuyo sitio web es");
define('_COM_C_DATE_ON',"el");
define('_COM_C_DATE_AT',"a");
define('_COM_C_ADD_COM',"Agrega tus comentarios a este artículo...");
define('_COM_C_ADD_COM2'," ...");
define('_COM_C_NAME',"Nombre");
define('_COM_C_EMAIL',"E-Mail");
define('_COM_C_EMAIL_NOT',"Tu email no será mostrado en este sitio - sólo al administrador");
...
define('_COM_C_QUICKLINK',"Enlace rápido para ingresar");
define('_COM_C_THANKS',"Gracias por tu comentario sobre");
define('_COM_C_THANKS2',"Gracias por tu comentario sobre el siguiente artículo");
define('_COM_C_ADMIN_REV',"Un administrador revisará su comentario a la brevedad");
define('_COM_C_ENTERED',"Usted ingresó");
define('_COM_C_VISIT',"Por favor viste nuestro sitio nuevamente en ");
define('_COM_C_THANKS3',"Gracias por su comentario - Ha sido agregado a esta página");
define('_COM_C_THANKS4',"Gracias por su comentario - Será revisado por un administrador antes de ser publicado!");
define('_COM_C_SUBMIT',"Enviar");
define('_COM_C_RESET',"Limpiar");
define('_COM_C_NOT_AUTH',"No está autorizado a dejar comentarios - Por favor, ingrese como usuario.");
define('_COM_C_PREV_PAGE',"Página Anterior");
define('_COM_C_NEXT_PAGE',"Página Siguiente");
...
define('_COM_C_PREVIEW_INTRO',"¿Está correcto lo de abajo? <p />Por favor, haga cualquier cambio necesario antes de enviar.  Advertencia : Cancelando borrará tu comentario!");
